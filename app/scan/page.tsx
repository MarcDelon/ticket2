    ...
    <main className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline">{t("scan.back")}</span>
          </Link>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="p-5 sm:p-6 rounded border border-gray-200 bg-gray-50">
          <h3 className="text-gray-900 font-medium mb-3 text-xs sm:text-sm">{t("scan.instructions")}</h3>
          <ul className="space-y-2 text-gray-700 text-xs font-light">
            <li>• {t("scan.allowCamera")}</li>
            <li>• {t("scan.pointCamera")}</li>
            <li>• {t("scan.holdSteady")}</li>
            <li>• {t("scan.oneEntry")}</li>
            <li>• {t("scan.permanentlyInvalid")}</li>
          </ul>
        </div>
      </div>
    </main>
